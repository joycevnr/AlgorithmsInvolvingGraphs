 ...
 * 
 * 
 * Os grafos são representados como listas de adjacência contendo pesos inteiros.
 * 
...
class DijkstraTest {
	...
	void setUp() throws Exception {
		...
		int[][] grafo2 = {{0, 1, 2, 5, 4}, {1, 0, 1, 1, 3}, {2, 1, 0, 4, 5}, {5, 1, 4, 0, 1}, {4, 3, 5, 1, 0}};
	...
	/**
	 * Testa se o método lança {@code IndexOutOfBoundsException} ao receber índices inválidos
	 * como origem para o algoritmo de Dijkstra (menores que 0 ou maiores que o número de vértices).
	 */
	@Test
	void testException() {
	...
	/**
	 * Testa se o método {@code menor_caminho_semFila} retorna as menores distâncias corretas
	 * entre a origem e os demais vértices para diferentes grafos.
	 */
	@Test
	void testMenorCaminhoSemFilaDistancias() {
		int[][] caminho = dijkstra.menor_caminho_semFila(grafoMenor, 0); // calcula as menores distancias e os melhores caminhos entre o vertice 0 e os outros vertices
	...
	/**
	 * Testa se o método {@code printCaminho} reconstrói corretamente os caminhos mínimos
	 * a partir do vetor de pais gerado pelo algoritmo de Dijkstra sem uso de fila de prioridade.
	 */
	@Test
	...
	/**
	 * Testa se o método {@code menor_caminho_comFila} retorna as menores distâncias corretas
	 * entre a origem e os demais vértices para diferentes grafos.
	 */
	@Test
	void testMenorCaminhoComFilaDistancias() {
		int[][] caminho = dijkstra.menor_caminho_comFila(grafoMenor, 0); // calcula as menores distancias e os melhores caminhos entre o vertice 0 e os outros vertices
		assertEquals(0, caminho[0][0]); // de um vertice até ele mesmo a distancia é zero
		assertEquals(1, caminho[0][1]);
		assertEquals(2, caminho[0][2]);
	...
	/**
	 * Testa se o método {@code printCaminho} reconstrói corretamente os caminhos mínimos
	 * a partir do vetor de pais gerado pelo algoritmo de Dijkstra com uso de fila e prioridade.
	 */
	@Test
